...
def parse_args():
    ...
    parser.add_argument('--sigma', type=float,  default=0.25, help='Noise for adversarial training [default: 0.25]')
...
def main(args):
    ...
    for epoch in range(start_epoch,args.epoch):
        ...
        for i, data in tqdm(enumerate(trainDataLoader), total=len(trainDataLoader), smoothing=0.9):
            ...
            points[:,:, 0:3] = points[:, :, 0:3] + args.sigma * torch.randn_like(points[:, :, 0:3])
